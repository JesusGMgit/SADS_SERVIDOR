...
switch ($_SERVER['REQUEST_METHOD']) {
    ...
    case 'POST':
        ...
        if($_POST != NULL) {
            if(isset($_POST['T_AID'])){
                ...
                soldadura_interna::crear_registro_tuberia_interna("tuberia_soldadura_interna_1",$_POST['T_ID_tubo'],$_POST['T_No_tubo'],$_POST['T_No_placa'],
    ...
    case 'GET':
        ...
        if(isset($_GET[$Garray[0]])){
            ...
            echo json_encode(soldadura_interna::obtener_todos_registros_interna("tuberia_soldadura_interna_1"));
        }//end else
    ...
    case 'PUT':
        ...
        $i=0;
        if($_PUT != NULL) {
            $Maquina="tuberia_soldadura_interna_1";
