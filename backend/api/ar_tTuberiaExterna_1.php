...
switch ($_SERVER['REQUEST_METHOD']) {
    ...
    case 'POST':
        ...
        if($_POST != NULL) {
            if(soldadura_externa::crear_registro_tuberia_externa("tuberia_soldadura_externa_1",$_POST['T_ID_tubo'],$_POST['T_No_tubo'],$_POST['T_No_placa'],
    ...
    case 'DELETE':
        ...
        if(isset($_GET['T_ID_tubo'])){
            if(soldadura_externa::borrar_tubo_externa("tuberia_soldadura_externa_1",$_GET['T_ID_tubo'])) {
                http_response_code(200);
            }//end if
            else {
                http_response_code(400);
