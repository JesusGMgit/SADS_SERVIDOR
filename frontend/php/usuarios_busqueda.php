...
<!DOCTYPE html>
<html>
<?php require_once "../../backend/clases/clase_conexion.php";
...
<body class="w3-container w3-border-left w3-border-right">
    ...
    <nav class="w3-sidebar w3-light-grey w3-collapse w3-top" style="z-index:3;width:300px" id="mySidebar">
            ...
            <div>
                ...
                <select onchange="combo_proyectos()" id="proyectos">
                    ...
                    <?php //esta parte fue en en php para cargar en la tabla la tuberia que coincida
                      ...
                      foreach ($conexion_db->query('SELECT Pro_ID,Pro_OrdenTrabajo from proyectos') as $row) { ?>
        ...
        <div class="w3-container w3-display-container w3-padding-16 w3-border-top w3-border-bottom">
            <!-- Mostrara los datos de la tuberia con la No de tubo -->
            <p><label><i class="fa fa-sticky-note-o"></i> No DE TUBO</label></p>
            <div class="w3-row">
        ...
        <div class="w3-container w3-display-container w3-padding-16 w3-border-top w3-border-bottom">
            ...
            <div class="w3-row">
                <div class="w3-col s9 w3-center"><input class="w3-input w3-border" type="text" placeholder="xxxxx" id="ID_tubo" name="ID_tubo"></div>
                <div class="w3-col s3 w3-center"><button onclick="ID_tubo_busqueda()" type="button" class="w3-button w3-white w3-border w3-border-blue">buscar</button></div>
            </div>
        </div>
    ...
    <div class="w3-main w3-white" style="margin-left:300px">
        ...
        <section id="INTERNAS" class="w3-padding">
