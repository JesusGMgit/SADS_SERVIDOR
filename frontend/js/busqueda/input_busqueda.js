...
function ID_tubo_busqueda(){
    tubo=document.getElementById('ID_tubo').value;
    document.getElementById('INTERNAS').innerHTML = "";
    document.getElementById('EXTERNAS').innerHTML = "";
    console.log(tubo);
    for(i=1;i<=3;i++){
...
function no_tubo_busqueda(){
    ...
    console.log(tubo);
    for(i=1;i<=3;i++){
        urlf = direccion_pagina + "/api/externas/rq_tTuberiaExterna_"+i+".php?no_tubo="+tubo;
        tabla_externas_fnt(urlf,("EXTERNA"+i));
        urlf = direccion_pagina + "/api/internas/rq_tTuberiaInterna_"+i+".php?no_tubo="+tubo;
        tabla_internas_fnt(urlf,("INTERNA"+i));
    }
